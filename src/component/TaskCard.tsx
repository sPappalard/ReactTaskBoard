...
if(isDragging){
  ...
  if (editMode){
    ...
    <div 
        ...
        <textarea className=" 
            ...
            focus:outline-none
            "
            value={task.content}  //set the value of text area
            autoFocus
            placeholder="Task content here"
            onBlur={toggleEditMode}
            onKeyDown={(e) => {                     //when I quit the EditMode (press Enter in Keyboard)
  ...
  <div
    ...
    className   //show the button only when MouseOver = true (when the mouse enter in the task div)
    ="         
        stroke-white 
        absolute right-4 
        top-1/2 
